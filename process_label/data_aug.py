...
if __name__ == "__main__":
    # 原始的img与xml文件路径
    set = 'val'
    IMG_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OWOD-Plant/datasets/VOC2007/JPEGImages"
    XML_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OWOD-Plant/datasets/VOC2007/Annotations"
    # 存储增强后的XML文件夹路径
    AUG_XML_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OWOD-Plant/datasets/VOC2007/Annotations_aug"
    try:
    ...
    mkdir(AUG_XML_DIR)
    # 存储增强后的影像文件夹路径
    AUG_IMG_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OWOD-Plant/datasets/VOC2007/JPEGImages_aug"
    try:
    ...
    for root, sub_folders, files in os.walk(XML_DIR):
        for name in tqdm(files):
            ...
            if "wilt" in instances:
                AUGLOOP = 3
            elif ("physical_damage" in instances) or ("old" in instances):
                AUGLOOP = 2
